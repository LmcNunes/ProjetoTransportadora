...
def verificarCondicao(altura,largura,peso):
  if(altura >= 10 and altura <= 140 and peso >0):
      if(largura >= 6 and largura <= 125):
          valorFrete = (peso * 0.3) / 10
          return  message("Entrega Kabum", valorFrete, dias=4)
          pass
      pass
      ...
      if(largura >= 13 and largura <= 125):
          valorFreteK = (peso * 0.5) / 10
          valorFreteN = (peso * 0.2) / 10
          return messageEmpresas("Entrega Kabum", valorFreteK, 4, "Entrega Ninja ",valorFreteN,6,) 
          pass
      pass
